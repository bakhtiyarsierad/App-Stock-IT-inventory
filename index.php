...
//------------------------------------ Summary Data ---------------------------------------------
		...
		$qrmasuk= mysqli_query($con,"select sum(jumlah) as masuk from transaksi where (jenis_transaksi='Masuk')");
		...
		$qrkeluar= mysqli_query($con,"select sum(jumlah) as keluar from transaksi where (jenis_transaksi='Keluar')");
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<a href="laporan1.php"><div class="text-muted">Out of Stock</div></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="alert bg-success" role="alert">
					<span class="glyphicon glyphicon-check"></span> Untuk request barang ke gudang pusat klik <a href="request.php">DISINI </a> <a href="request.php" class="pull-right"> <span class="glyphicon glyphicon-shopping-cart"></span></a>
				</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">'.$jmlreq.'</div>
							<a href="request.php"><div class="text-muted">Total Request</div></a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">'.$jmlopen.'</div>
							<a href="request.php"><div class="text-muted">Pending</div></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">'.$jmlapv.'</div>
							<a href="request.php"><div class="text-muted">Approved</div></a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">'.$jmlrej.'</div>
							<a href="request.php"><div class="text-muted">Rejected</div></a>
						</div>
					</div>
				</div>
			</div>
...
//------------------------------------ Tampilkan daftar to-do list ---------------------------------------------							
							...
							$qrlist=mysqli_query($con,"select * from todo");
